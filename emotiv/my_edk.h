...
extern "C"
{
	...
	*/
	...
	typedef EDK_API int (*TEE_EngineConnect)(const char* strDevID); // = "Emotiv Systems-5");
	...
	*/
	...
	/*!
		...
		\sa edkErrorCode.h
	*/
	typedef EDK_API int (*TEE_EngineDisconnect)() ;
	...
	*/
	...
	typedef EDK_API EmoEngineEventHandle (*TEE_EmoEngineEventCreate) ();
	...
	*/
	...
	typedef EDK_API void (*TEE_EmoEngineEventFree) (EmoEngineEventHandle hEvent);
	...
	*/
	...
	typedef EDK_API EmoStateHandle (*TEE_EmoStateCreate) ();
	...
	*/
	typedef EDK_API void (*TEE_EmoStateFree)(EmoStateHandle hState);
	...
	*/
	...
	typedef EDK_API EE_Event_t (*TEE_EmoEngineEventGetType)(EmoEngineEventHandle hEvent);
	...
	*/
	...
	typedef EDK_API int (*TEE_EmoEngineEventGetUserId)(EmoEngineEventHandle hEvent, unsigned int *pUserIdOut);
	...
	*/
	...
	typedef EDK_API int (*TEE_EngineGetNextEvent)(EmoEngineEventHandle hEvent);
	...
	*/
	...
	/*!
		...
		\return EDK_ERROR_CODE
                - EDK_ERROR_CODE = EDK_OK if successful
	*/
	typedef EDK_API int (*TEE_DataUpdateHandle)(unsigned int userId, DataHandle hData);
	...
	/*!
		...
		\return EDK_ERROR_CODE
                - EDK_ERROR_CODE = EDK_OK if successful
	*/
	typedef EDK_API int (*TEE_DataGet)(DataHandle hData, EE_DataChannel_t channel, double buffer[], unsigned int bufferSizeInSample);
	...
	/*!
		...
		\return EDK_ERROR_CODE
                - EDK_ERROR_CODE = EDK_OK if successful
	*/
	typedef EDK_API int (*TEE_DataGetNumberOfSample)(DataHandle hData, unsigned int* nSampleOut);
	...
	*/
	...
	typedef EDK_API int (*TEE_DataSetBufferSizeInSec)(float bufferSizeInSec);
	...
	*/
	...
	typedef EDK_API int (*TEE_DataAcquisitionEnable)(unsigned int userId, bool enable);
