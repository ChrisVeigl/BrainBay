...
extern "C"
{
	...
	*/
	typedef EMOSTATE_DLL_API int (*TES_GetContactQualityFromAllChannels)(EmoStateHandle state, EE_EEG_ContactQuality_t* contactQuality, size_t numChannels);
	...
	*/
	typedef EMOSTATE_DLL_API EE_SignalStrength_t (*TES_GetWirelessSignalStatus)(EmoStateHandle state);
	...
	*/
	...
	typedef EMOSTATE_DLL_API void (*TES_GetBatteryChargeLevel)(EmoStateHandle state, int* chargeLevel, int* maxChargeLevel);
};
