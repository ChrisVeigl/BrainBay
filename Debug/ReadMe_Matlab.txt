...
The matlab object works only with the commercially available Matlab distribution
from mathworks, and it needs a special brainbay - build. 
Please contact chris@shifz.org if you want a build which supports the matlab object.
