...
unsigned char ARRAY3600OBJ::getCheckByte(unsigned char* command) {
        int cb=0;
        for (unsigned char i=0; i < 25; i++) {
                cb += (int) command[i];
        }
        //cb = cb >> 8;
        return (unsigned char)(cb);
}

unsigned char ARRAY3600OBJ::getHighByte(int val) {
        return (unsigned char)(val >> 8);
}

unsigned char ARRAY3600OBJ::getLowByte(int val) {
        return (unsigned char)(val);
}


void ARRAY3600OBJ::setToSelfControl() {
	unsigned char command[] = { 0xAA, 0x00, 0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2C };
        WriteComPort(comdev, command, 26);
}

void ARRAY3600OBJ::setToPcControlOn() {
	unsigned char command[] = { 0xAA, 0x00, 0x82, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2F };
        command[25] = getCheckByte(command);
        WriteComPort(comdev, command, 26);
}

void ARRAY3600OBJ::setToPcControlOff() {
	unsigned char command[] = { 0xAA, 0x00, 0x82, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2E };
        command[25] = getCheckByte(command);
        WriteComPort(comdev, command, 26);
}

void ARRAY3600OBJ::setParameters(unsigned char address, int maxI, int maxU, int maxP, int u) {
	unsigned char command[] = { 0xAA, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        command[1] = address;
