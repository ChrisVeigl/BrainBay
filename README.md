BrainBay Bio- and Neurofeedback application
-------------------------------------------

Welcome to the BrainBay Github repository !
The current release version is 1.9 (27-12-2013)

Recent changes include support of biosignal amplifiers (Emotiv Epoc, OpenBCI)
